...
public class NPCRenderer extends MobEntityRenderer<NPCEntity, NPCModel<NPCEntity>> {
    ...
    public Identifier getTexture(NPCEntity entity) {
        ...
        return switch (entity.getVariant()) {
            case 0 -> 43 -> Identifier.of("civiliansmod", String.format("textures/entity/npc/default/default_%d.png", variant));
            case 44 -> 87 -> Identifier.of("civiliansmod", String.format("textures/entity/npc/slim/slim_%d.png", variant - 44));
